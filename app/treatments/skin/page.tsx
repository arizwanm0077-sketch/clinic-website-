...
export const metadata: Metadata = {
  title: "Medical Dermatology & Resurfacing | Treatments",
  description: "Advanced dermatologist-led skincare, chemical peels, and scar remodeling therapies.",
};

export default function SkinTreatmentsPage() {
  const treatments = treatmentsData.filter(t => t.category === "skin");
      ...
      <Section spacing="hero" surface="ivory" className="border-b border-brand-stone/30">
        <Container size="narrow" className="text-center">
          <Stack gap="md" align="center">
            ...
            <Heading level={1} size="xl">Medical Dermatology & Resurfacing</Heading>
            <BodyText size="lg" muted className="mt-4 max-w-2xl mx-auto">
              Our clinical skin care is rooted in deep barrier science. We focus on diagnosing chronic conditions, calming active dermal inflammation, and safely restructuring scar tissue.
            </BodyText>
          </Stack>
        </Container>
      </Section>
              ...
              <Card key={t.id} surface="white" className="p-8 border border-brand-stone/40 hover:border-brand-sand transition-all duration-300">
                <Stack gap="md">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    ...
                    <Button as="link" href={`/treatments/skin/${t.id}`} variant="primary" size="sm">
